// Démonstration lib_1306_rot.ino v2 exemple test_lib_1306_rot_v5f.ino
// Novembre 2023
// https://castoo.fr
...
//
// Exemple en version 5 fils avec un ESP8266-12
...
#define adr_i2c_io 0 // On met 0 comme on n'utilise pas de PCF85741
...
const String ch_menuA[] = {"Saisie de Fréquence", "Saisie de poids ", "Menu déplacements", "Saisir un Nom"};
